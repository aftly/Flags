...
## 🛠 Design
- Built with Jetpack Compose in Kotlin, trying to follow architecture principles from [Android Developers](https://developer.android.com/topic/architecture) such as UDF, SSOT, declarative state, separation of concerns, and ViewModels for managing business state and logic.
