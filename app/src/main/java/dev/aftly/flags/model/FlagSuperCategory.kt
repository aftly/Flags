...
sealed class FlagSuperCategory(
    ...
    fun allChildSupers(
        categories: List<FlagSuperCategory> = supers()
    ...
    data object Regional : FlagSuperCategory(
        ...
        subCategories = listOf(
            ...
            FlagCategoryWrapper(enum = FlagCategory.COLONY),
            FlagCategoryWrapper(enum = FlagCategory.COMMUNITY),
            FlagCategoryWrapper(enum = FlagCategory.COUNCIL_AREA),
            ...
            FlagCategoryWrapper(enum = FlagCategory.MICRONATION),
            ...
            FlagCategoryWrapper(enum = FlagCategory.RIDING),
